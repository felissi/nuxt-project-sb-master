...
console.log(`🚀 // DEBUG 🍔 ~ file: build-api.cjs:7 ~ componentPath:`, componentPath)
console.log(`🚀 // DEBUG 🍔 ---------------------------------------------------------------------🚀 // DEBUG 🍔`)
...
console.log(`🚀 // DEBUG 🍔 --------------------------------------------------------------------------🚀 // DEBUG 🍔`)
console.log(`🚀 // DEBUG 🍔 ~ file: build-api.cjs:19 ~ veturAttributes:`, veturAttributes)
console.log(`🚀 // DEBUG 🍔 --------------------------------------------------------------------------🚀 // DEBUG 🍔`)

const files = fs.readdirSync(componentPath);
console.log(`🚀 // DEBUG 🍔 ------------------------------------------------------🚀 // DEBUG 🍔`);
console.log(`🚀 // DEBUG 🍔 ~ file: build-api.cjs:20 ~ files:`, files);
console.log(`🚀 // DEBUG 🍔 ------------------------------------------------------🚀 // DEBUG 🍔`);
...
const createWebTypes = (component) => {
  const url =
    showcaseURL + `${component["doc-url"] ? component["doc-url"] : component.name.toLowerCase()}`;
